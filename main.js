    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].Children.map(this.props.children, function (child) {
          return _react2['default'].cloneElement(child, (0, _sublimemediaWickerManUtilities.extend)({}, _this3.state.data, { persist: _this3.props.persist }, child.props));
        }, this)
      );
    }
  }]);
...
WMInjector.propTypes = {
  ...
  persist: _react2['default'].PropTypes.func
};
